...
Variable | AUC excluding variable | Ranking | Comment
-------- | -------- | ---- | ----------------------------- 
idx_win_aerial_ball     | 0.88     | Last    | AUC went up without this variable, likely due to multicollinearity
idx_less_frees          | 0.87     | 5th     | Negligible impact to AUC
**idx_win_ground_ball** | **0.84** | **2nd** | **Strong impact to AUC**
idx_less_clangers       | 0.86     | =3rd    | Some impact to AUC
**idx_50m_entry**       | **0.83** | **1st** | **Strong impact to AUC**
Inside_50s              | 0.86     | =3rd    | Some impact to AUC


## TO DO

Items I have yet to write up / finish off.
...
- Yet to test accuracy using the same methodology

### Conclusions

- There are factors which are strong drivers of winning AFL matches
- (analysis not complete) Ability to predict match results
